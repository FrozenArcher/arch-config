...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "e", function () awful.spawn.with_shell("~/scripts/powermenu.sh -e 'pkill awesome'") end,
    ...
    awful.key({ modkey, "Shift"   }, "period", function () awful.layout.inc( 1)                end,
              {description = "select next", group = "layout"}),
    awful.key({ modkey, "Shift"   }, "comma", function () awful.layout.inc(-1)                end,
    ...
    -- Menubar
    awful.key({ modkey }, "p", function() awful.spawn.with_shell("~/scripts/rofi-appmenu.sh") end,
              {description = "show rofi appmenu", group = "launcher"})
)
